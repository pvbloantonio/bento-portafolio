...
export const siteConfig = {
  creator: "Pablo Elgueta",
  title: "Desarrollador de Software",
  bio: "Ingeniero de Software especializado en el desarrollo integral de soluciones tecnológicas con un enfoque detallado en la calidad y la innovación.",
